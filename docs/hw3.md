 ...
 * Создадим проект и настроим интеграцию с github
 ...
 webhook было бы настроить прикольно, но у меня нет белого IP. В целом о том как настроить webhook [статья в помощь](https://habr.com/ru/companies/slurm/articles/721520/)
 Есть идея прокинуть через ngrok, но это на будущее
